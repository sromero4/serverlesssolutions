"""
Django settings for sss_backend project.
...
INSTALLED_APPS = THIRD_PARTY_APPS + DJANGO_APPS + LOCAL_APPS_CONJUNTO + LOCAL_APPS_RESTAURANT + LOCAL_APPS_AUTH
...
WSGI_APPLICATION = 'sss_backend.wsgi.application'
