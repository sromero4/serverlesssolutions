...
urlpatterns = [
    ...
    path('ingredientes/', include('Apps.restaurant.ingrediente.urls'), name='restaurant_ingredientes'),
    # path('ingredientes/add/', name='restaurant_add_ingrediente'),
    ...
    # # Restaurant - Ingredientes
    # path('ingredientes/', views.restaurant_ingredientes_view, name='restaurant_ingredientes'),
    # path('ingredientes/add/', views.restaurant_add_ingrediente_view, name='restaurant_add_ingrediente'),
