                        ...
                        <div class="row g-2">
                            <div class="col-xl-9 col-md-12 docs-buttons">
                                ...
                                <div class="btn-group p-2">
                                    ...
                                    <button class="btn btn-outline-primary" v-on:click="flipvertical" type="button"
                                ...
                                <div class="btn-group p-2">
                                    <button class="btn btn-outline-primary" type="button" v-on:click="disable"
                                    ...
                                    <button class="btn btn-outline-primary" type="button" v-on:click="enable"
                                ...
                                <div class="btn-group p-2">
                                    ...
                                    <button class=" btn btn-outline-primary" id="inputImage" v-on:click="imageUpload"
                                    ...
                                    <button class="btn btn-outline-primary" type="button" v-on:click="destroy"
                                ...
                                <div class="btn-group btn-group-crop p-2">
                                    <button class="btn btn-primary p-2" type="button" data-method="getCroppedCanvas"><span
                                            class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button class="btn btn-primary m-2" type="button" data-method="getCanvasData" data-option=""
                                ...
                                <button class="btn btn-primary m-2" type="button" data-method="getCropBoxData"
                                ...
                                <button class="btn btn-primary m-2" type="button" data-method="moveTo" data-option="0"
                                ...
                                <button class="btn btn-primary m-2" type="button" data-method="zoomTo" data-option="1"
                                    v-on:click="zoom100"><span class="docs-tooltip" data-bs-toggle="tooltip"
                                        data-animation="false" title="cropper.zoomTo(1)">Zoom to
                                        100%</span></button>
                                <button class="btn btn-primary m-2" type="button" data-method="rotateTo" data-option="180"
                                    v-on:click="rotate180"><span class="docs-tooltip" data-bs-toggle="tooltip"
                                        data-animation="false" title="cropper.rotateTo(180)">Rotate 180°</span></button>
                                <button class="btn btn-primary m-2" type="button" data-method="scale" data-option="-2"
...
let desc = ref<string>("Use the image cropper.js")
