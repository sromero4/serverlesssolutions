        ...
        <div class="col-sm-4">
            <div class="mb-3">
                <multiselect v-model="multiValue" tag-placeholder="Add this as new tag" placeholder="Select Your Name"
                    label="name" track-by="code" :options="options" :multiple="false" :taggable="true">
                </multiselect>
            </div>
        </div>
        <div class="col-sm-4">
...
const multiValue = ref([{ code: 1, name: 'January' }])
const Value = ref([{ code: 1, name: '1' }])
const Value1 = ref([{ code: 1, name: '1985' }])
